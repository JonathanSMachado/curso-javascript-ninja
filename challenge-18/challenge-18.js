(function () {
    ...
    */
    ...
    console.log(phrase.match(/(ju.ho)/g))
    ...
    */
    ...
    const html = "<div><section><blockquote>Texto <img /></blockquote></section></div>"
    ...
    */
    ...
    const emptyHTML = "<div><ul><li></li><li></li><li><span></span></li></ul></div>"

    console.log(emptyHTML.match(/<\w+><\/\w+>/g))
    ...
    */
    ...
    function replaceText(text) {
        return text.replace(/<(\w+)>([^<]+)<\/\w+>/g, '<$1>O texto dentro da tag "$1" é "$2"</$1>')
    }
