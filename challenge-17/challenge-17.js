(function () {
    ...
    */
    ...
    console.log( text.replace(/Manuel Marques de Sousa/g, 'Jonathan Machado') )
    ...
    */
    ...
    console.log( text.replace( /brasileiro/, 'montenegrino' ) )
    ...
    */
    ...
    function getMonthNumber(monthName) {
        ...
        return ('0' + (months.indexOf(monthName.toLowerCase()) + 1)).slice(-2)
    }
    ...
    */
    ...
    var regexDate = /(\d\d)(junho|julho)(\d\d\d\d)/
